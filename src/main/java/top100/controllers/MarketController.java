...
public class MarketController {
    ...
    @RequestMapping("/market/calculations/run")
...
//    @RequestMapping("/market/calculations/prices/run")
//    public String performMarketCalculationForPrices() {
//
//        List<Company> companies = marketInterface.getMarketForCalculations();
...
//                transaction.setTrades(null);
//            }
//            CompanyPrice companyPrice = new CompanyPrice(company.getId(), transactions);
